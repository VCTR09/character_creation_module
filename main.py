...
def attack(char_name: str, char_class: str) -> str:
    """Calculate the damage which player cause to his opponent."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate the damage percentage which was blocked by the player."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Apply the character's special abilities."""
    if char_class == 'warrior':
...
def main() -> str:
    """Greet the character. Bring him into action."""
